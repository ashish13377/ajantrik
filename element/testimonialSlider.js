              ...
              <div className="swiper-wrapper">
                <Slider {...settings}>
                  <div className="swiper-slide">
                    <div className="testimonial-4 quote-right">
                      <div className="testimonial-text">
                        <strong className="testimonial-name">Bhagat Singh</strong>
                  ...
                  <div className="swiper-slide">
                    <div className="testimonial-4 quote-right">
                      <div className="testimonial-text">
                        <strong className="testimonial-name">Ayushman Kumar</strong>
                        <span className="testimonial-position text-primary m-b20">
                          CEO & Founder{" "}
                        </span>
                        <p>
                  ...
                  <div className="swiper-slide">
                    <div className="testimonial-4 quote-right">
                      <div className="testimonial-text">
                        <strong className="testimonial-name">Pranav singh</strong>
                        <span className="testimonial-position text-primary m-b20">
                          CEO & Founder{" "}
                        </span>
                        <p>
